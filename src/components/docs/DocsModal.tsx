            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-blue-100 text-sm mt-1">KDP Word Search Puzzle Generator</p>
                    </div>
                    <button
                        onClick={onClose}
                    ...
                    <div className="prose prose-slate max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <div className="space-y-4">
                                <div className="bg-slate-50 rounded-lg p-4">
                                    <h4 className="font-semibold text-slate-900 mb-2">Grid Size (10-25)</h4>
                                ...
                                <div className="bg-slate-50 rounded-lg p-4">
                                    <h4 className="font-semibold text-slate-900 mb-2">Difficulty Levels</h4>
                                    <ul className="text-sm text-slate-600 space-y-1 ml-4">
                                        <li><strong>Easy:</strong> Horizontal and vertical only</li>
                                        <li><strong>Medium:</strong> Adds diagonal directions</li>
                                        <li><strong>Hard:</strong> Includes reverse directions</li>
                                        <li><strong>Expert:</strong> All directions including reverse diagonals</li>
                                    </ul>
                                </div>

                                <div className="bg-slate-50 rounded-lg p-4">
                                    <h4 className="font-semibold text-slate-900 mb-2">Shapes</h4>
                                    <ul className="text-sm text-slate-600 space-y-1 ml-4">
                                        <li><strong>Rectangle:</strong> Standard full grid</li>
                                        <li><strong>Circle:</strong> Circular masked grid</li>
                                    </ul>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-slate-700 mb-4">
                                Choose from 8 professionally designed themes. The preview shows exactly how your PDF will look!
                            </p>
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="bg-gradient-to-br from-pink-50 to-yellow-50 rounded-lg p-3 border border-pink-200">
                                ...
                                <div className="bg-gradient-to-br from-slate-900 to-cyan-900 rounded-lg p-3 border border-cyan-400">
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="space-y-2 text-slate-700">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span><strong>Word Length:</strong> Mix short and long words for better placement</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 font-bold">•</span>
                                    <span><strong>Grid Size:</strong> Use larger grids (20+) for 15+ words</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 font-bold">•</span>
                                ...
                                <li className="flex items-start gap-2">
                                    <span className="text-blue-600 font-bold">•</span>
                                    <span><strong>Answer Key:</strong> PDFs include an answer key on page 2</span>
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="space-y-3">
                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                    <h4 className="font-semibold text-amber-900 mb-1">Words not fitting?</h4>
                                    <p className="text-sm text-amber-800">Increase grid size or reduce number of words</p>
                                </div>
                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                    <h4 className="font-semibold text-amber-900 mb-1">Export button disabled?</h4>
                                    <p className="text-sm text-amber-800">Generate a puzzle first before exporting</p>
                                </div>
                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                    <h4 className="font-semibold text-amber-900 mb-1">Preview cut off?</h4>
                                    <p className="text-sm text-amber-800">The canvas auto-scales - try zooming your browser</p>
                                </div>
                            </div>
                        </section>
                    </div>
                ...
                <div className="bg-slate-50 px-8 py-4 border-t border-slate-200">
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-slate-600">
                            Version 1.0.0 • Built for KDP Publishers
                        </p>
                        <button
                            onClick={onClose}
